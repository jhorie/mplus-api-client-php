...
class MplusQAPIclient
{
    ...
    {
        try {
            $result = $this->client->getArticleAlterationsGroups(['request' => ['groupType' => $groupType, 'syncMarker' => $syncMarker, 'syncMarkerLimit' => $syncMarkerLimit]]);
            if ($this->returnRawResult) {
                return $result;
            }
...
class MplusQAPIDataParser
{
    ...
    public function parseCustomFieldLists($soapCustomFieldLists)
    {
        ...
        if (isset($soapCustomFieldLists->articleCustomFieldList)) {
            if (!is_array($customFieldLists)) {
                $customFieldLists = array();
            }
